    ...
    <div className="profile">
      ...
      <div className="profile__header shop-rise" style={{ '--rise-index': 0 } as CSSProperties}>
        <div className="profile__info">
          ...
          {roleStyles ? (
            <div
              className="profile__role-badge"
              style={{ backgroundColor: roleStyles.backgroundColor }}
            >
              {roleStyles.icon}
            </div>
          ) : null}
      ...
      <h5 className="profile__menu-title shop-rise" style={{ '--rise-index': 1 } as CSSProperties}>
        حساب کاربری
      </h5>
      <div className="profile__menu-box shop-rise" style={{ '--rise-index': 2 } as CSSProperties}>
        <button
          ...
          onClick={() => handleMenuClick(() => navigate('/profile/info'))}
        >
        ...
        <button
          type="button"
          className="profile__menu-item"
          onClick={() => handleMenuClick(() => navigate('/profile/cards'))}
        >
          <span className="profile__menu-start">
            <span className="profile__menu-icon">
      ...
      <h5 className="profile__menu-title shop-rise" style={{ '--rise-index': 3 } as CSSProperties}>
        سفارشات و تاریخچه
      </h5>
      ...
      <h5 className="profile__menu-title shop-rise" style={{ '--rise-index': 5 } as CSSProperties}>
        سایر
      </h5>
      <div className="profile__menu-box shop-rise" style={{ '--rise-index': 6 } as CSSProperties}>
        <button
          type="button"
          className="profile__menu-item"
          onClick={() => handleMenuClick(() => setIsThemeSheetOpen(true))}
        >
          <span className="profile__menu-start">
            <span className="profile__menu-icon">
        ...
        <button
          type="button"
          className="profile__menu-item"
          onClick={() => handleMenuClick(() => setIsSocialSheetOpen(true))}
        >
          <span className="profile__menu-start">
            <span className="profile__menu-icon">
              <SocialMediaIcon width={18} height={18} />
            </span>
            <span>PanelOut در شبکه های اجتماعی</span>
          </span>
          <ArrowIcon />
        </button>
      </div>
      ...
      {!inTelegram ? (
        <div className="profile__logout shop-rise" style={{ '--rise-index': 7 } as CSSProperties}>
      ...
      {showCredits ? (
        <p className="profile__credits shop-rise" style={{ '--rise-index': 8 } as CSSProperties}>
          <span>ساخته شده با</span>
          <span className="profile__credits-heart" aria-hidden>
            <SolarIcon icon="solar:heart-angle-bold" width={12} height={12} color="var(--accent)" />
          </span>
          <span>توسط</span>
          <a
      ...
      <BottomSheet
        ...
        title="PanelOut در شبکه های اجتماعی"
        options={[
          {
            value: 'channel',
            label: 'کانال تلگرام PanelOut',
            icon: <TelegramIcon width={18} height={18} color="#0088cc" />,
          },
          {
            value: 'bot',
            label: 'ربات تلگرام PanelOut',
            icon: <TelegramIcon width={18} height={18} color="#0088cc" />,
          },
        ]}
        ...
        onSelect={(value) => {
          haptic('light')
          if (value === 'channel') {
            window.open('https://t.me/PanelOut', '_blank', 'noopener,noreferrer')
          } else if (value === 'bot') {
            window.open('https://t.me/PanelOutBot', '_blank', 'noopener,noreferrer')
          }
        }}
      />
    </div>
