...
} from '../lib/adminSystemChannelsApi'
import { isTelegramWebApp } from '../lib/telegram'
import '../styles/shop-rise.css'
import './Admin.css'
import './AdminSystemChannels.css'
      ...
      {view === 'list' ? (
        <>
          ...
          {loading ? (
            ...
            <div className="admin-sys-ch__list shop-rise" style={{ '--rise-index': 2 } as CSSProperties}>
              {items.map((slot) => {
                      ...
                      {channel ? (
                        isAdminReport ? (
                          ...
                          <span className="admin-sys-ch__row-meta admin-sys-ch__row-meta--id">
                            @{channel.username}
                            {channel.isActive ? ' · قفل فعال' : ' · بدون قفل'}
                          </span>
                        )
                      ) : (
                        <span className="admin-sys-ch__row-meta">
        ...
        <section className="admin-sys-ch__add shop-rise" style={{ '--rise-index': 1 } as CSSProperties}>
          <div className="admin-sys-ch__steps">
            ...
            <button
              type="button"
              className="admin-sys-ch__btn admin-sys-ch__btn--ghost"
          ...
          <label className="admin-sys-ch__field">
            <span className="admin-sys-ch__field-label">لینک پست کانال</span>
            <div className="admin-sys-ch__field-row">
              <input
                className="admin-sys-ch__input"
                value={postLink}
                onChange={(event) => {
