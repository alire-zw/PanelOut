interface ChatQuestion01IconProps {
  width?: number | string
...
export default function ChatQuestion01Icon({
  width = 18,
  height = 18,
  color = 'currentColor',
  className,
}: ChatQuestion01IconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M19.6252 11H19.5002M19.7502 11C19.7502 11.1381 19.6383 11.25 19.5002 11.25C19.3621 11.25 19.2502 11.1381 19.2502 11C19.2502 10.8619 19.3621 10.75 19.5002 10.75C19.6383 10.75 19.7502 10.8619 19.7502 11Z"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M12.1257 11H12.0007M8.125 11H8M12.2507 11C12.2507 11.1381 12.1388 11.25 12.0007 11.25C11.8627 11.25 11.7507 11.1381 11.7507 11C11.7507 10.8619 11.8627 10.75 12.0007 10.75C12.1388 10.75 12.2507 10.8619 12.2507 11ZM8.25 11C8.25 11.1381 8.13807 11.25 8 11.25C7.86193 11.25 7.75 11.1381 7.75 11C7.75 10.8619 7.86193 10.75 8 10.75C8.13807 10.75 8.25 10.8619 8.25 11Z"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
