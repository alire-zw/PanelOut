interface DoNotTouch01IconProps extends React.SVGProps<SVGSVGElement> {
  width?: number | string
  height?: number | string
}

export default function DoNotTouch01Icon({
  width = 24,
  height = 24,
  ...props
}: DoNotTouch01IconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M13.5018 5.5C13.5018 4.67157 14.1733 4 15.0018 4C15.8302 4 16.5018 4.67157 16.5018 5.5V7.5M10.502 6.50045V5L10.5018 3.5C10.5018 2.67157 11.1733 2 12.0018 2C12.8302 2 13.5018 2.67157 13.5018 3.5V5.5M13.5018 5.5V9.50024M10.502 5C10.5016 4.17187 9.83019 3.50117 9.00197 3.50064C8.17376 3.50011 8 4 8 4M16.5018 12V7.5M16.5018 7.5C16.5018 6.67157 17.1733 6 18.0018 6C18.8302 6 19.5018 6.67157 19.5018 7.5V13.6668C19.5018 14.3812 19.5018 14.9897 19.49 15.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
